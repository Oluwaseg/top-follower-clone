...
export function ReviewBlock() {
  ...
  return (
    <section
      data-aos='fade-up'
      id='reviewBlock'
      className='mt-12 pt-12 pb-20 bg-[#FAFAFA] aos-init aos-animate'
    >
      <div className='container space-y-2'>
        {/* Hidden section (as per original HTML) */}
        <div className='space-y-2 hidden'>
          <div className='flex justify-center'>
            <span className='inline-flex rounded-full px-4 py-2 uppercase leading-6 tracking-[0.5px] w-fit bg-gradient-to-r from-indigo-400 to-indigo-600'>
              <span className='text-sm font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-500 uppercase'>
                Customer reviews
              </span>
            </span>
          </div>
        ...
        <div className='section-gradient-2'>
          {' '}
          {/* This class might need custom CSS if it's a complex gradient background */}
          <div className='flex justify-center pt-6'>
            <div className='card-wrapper'>
              <div className='rounded-[20px] bg-white text-card-foreground shadow-owncard p-6 sm:px-10 sm:py-8 w-full sm:min-w-[380px] flex flex-edited items-center justify-center'>
                ...
                <div>
                  {ratingDistribution.map((item) => (
                    ...
                    >
                      ...
                      <StarRating
                        rating={1}
                        className='h-5 w-5 fill-brand -mt-0.5'
                        totalStars={1}
                      />
                      <div className='px-2'>
